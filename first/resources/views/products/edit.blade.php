    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/edit/{{$editProd[0]->id}}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="product_name" 
                                value="{{ old('product_name') ?? $editProd[0]->product_name }}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                value="{{ old('product_quantity') ?? $editProd[0]->product_quantity }}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                name="product_code" 
                                value="{{ old('product_code') ?? $editProd[0]->product_code }}" 
